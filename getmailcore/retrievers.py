...
class SimpleIMAPRetriever(IMAPRetrieverBase, IMAPinitMixIn):
	...
	ConfBool(name='use_oauth_2_legged', required=False, default=False),
        ConfString(name='consumer_key',required=False,default=None),
        ConfString(name='consumer_key_secret',required=False,default=None),
